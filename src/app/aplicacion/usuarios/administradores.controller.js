(function () {
    ...
    angular
        ...
        .controller('AdministradoresController', AdministradoresController);

    /* @ngInject */
    function AdministradoresController($log, UsersResponse, UsersService, $mdDialog, $http, API_BACKEND, $mdToast) {
        var vm = this;
        ...
        vm.load = function () {
            vm.promise = UsersService.getAdministradores();
        ...
        function eliminarUser() {
            $http.delete(API_BACKEND.url + '/administrador/' + vm.selected[0].id)
                .then(function () {
                    $mdToast.show({
        ...
        vm.crearUsuario = function (ev) {
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/aplicacion/usuarios/administradores/administradores.create.tmpl.html',
                ...
                $http.post(API_BACKEND.url + '/administrador', response)
        ...
        vm.editarUsuario = function (ev) {
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/aplicacion/usuarios/administradores/administradores.edit.tmpl.html',
                parent: angular.element(document.body),
                targetEvent: ev,
                clickOutsideToClose: true,
                fullscreen: true,
