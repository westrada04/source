(function () {
    ...
    /* @ngInject */
    function EstudiantesController($log, UsersResponse, UsersService, $mdDialog, $http, API_BACKEND, $mdToast) {
        var vm = this;
        ...
        vm.load = function () {
            vm.promise = UsersService.getEstudiantes();
        ...
        function eliminarUser() {
            $http.delete(API_BACKEND.url + '/estudiante/' + vm.selected[0].id)
                .then(function () {
                    $mdToast.show({
        ...
        vm.crearUsuario = function (ev) {
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/aplicacion/usuarios/estudiantes/estudiantes.create.tmpl.html',
                ...
                $http.post(API_BACKEND.url + '/estudiante', response)
        ...
        vm.editarUsuario = function (ev) {
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/aplicacion/usuarios/estudiantes/estudiantes.edit.tmpl.html',
                parent: angular.element(document.body),
                targetEvent: ev,
                clickOutsideToClose: true,
                fullscreen: true,
