(function () {
    ...
    function themesConfig($mdThemingProvider, triThemingProvider, triSkinsProvider) {
        ...
        $mdThemingProvider.definePalette('azulUnimag', {
            '50': '#7bb6ef',
            '100': '#64a9ed',
            '200': '#4e9cea',
            '300': '#378fe7',
        ...
        $mdThemingProvider.definePalette('orangeUnimag', {
            '50': '#ffcc80',
            '100': '#ffc166',
            '200': '#ffb74d',
            '300': '#ffad33',
        ...
        triThemingProvider.theme('blue')
            .primaryPalette('azulUnimag')
            .accentPalette('orangeUnimag')
            .warnPalette('deep-orange');

        triThemingProvider.theme('blue-white')
